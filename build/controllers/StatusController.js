...
var StatusController = /** @class */ (function () {
    function StatusController(service, logger) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.service.getStatus(req.id)];
                    case 1:
                        result = _a.sent();
    ...
    StatusController = __decorate([
        inversify_express_utils_1.controller('/status'),
        __param(0, inversify_1.inject('service')), __param(0, inversify_1.named('status')),
